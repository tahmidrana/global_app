...
collection:{container:"DTTT_dropdown dropdown-menu",buttons:{normal:"",disabled:"disabled"}},print:{info:"DTTT_print_info"},select:{row:"active"}}),b.extend(!0,c.TableTools.DEFAULTS.oTags,{collection:{container:"ul",button:"li",liner:"a"}}))};"function"===typeof define&&define.amd?define(["jquery","datatables_old"],d):"object"===typeof exports?d(require("jquery"),require("datatables_old")):jQuery&&d(jQuery,jQuery.fn.dataTable)})(window,document);
