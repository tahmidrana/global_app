(function(f){"function"===typeof define&&define.amd?define(["jquery","datatables_old.net","datatables_old.net-buttons"],function(j){return f(j,window,document)}):"object"===typeof exports?module.exports=function(j,k){j||(j=window);if(!k||!k.fn.dataTable)k=require("datatables_old.net")(j,k).$;k.fn.dataTable.Buttons||require("datatables_old.net-buttons")(j,k);return f(k,j,j.document)}:f(jQuery,window,document)})(function(f,j,k,o){function l(a,b,d){var c=a.createElement(b);d&&(d.attr&&f(c).attr(d.attr),d.children&&
