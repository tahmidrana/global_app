...
*/
(function(e){"function"===typeof define&&define.amd?define(["jquery","datatables_old.net"],function(j){return e(j,window,document)}):"object"===typeof exports?module.exports=function(j,l){j||(j=window);if(!l||!l.fn.dataTable)l=require("datatables_old.net")(j,l).$;return e(l,j,j.document)}:e(jQuery,window,document)})(function(e,j,l,h){function v(b,c,a){var d;d=function(a,c){if(a>c)var d=c,c=a,a=d;var f=!1;return b.columns(":visible").indexes().filter(function(b){b===a&&(f=!0);return b===c?(f=!1,!0):f})};var f=
